...
<div class="landing--container" v-if="show">
 ...
 <div class="row">
 <div class="blog--wrapper col-xs-12 col-md-6 col-lg-4 " v-link="{name: post_by_id, params: {id: post.id}}" v-for="post in posts" v-bind:style="{background: post.custom_field.post_color }"> 
